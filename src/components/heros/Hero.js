...
const Hero = () => {
    return (
        <Fragment>
            <div id="hero" className="h-600 max-w-full">
                <div id="shape_1" className="bg-red-600 h-full text-center">
                    <div id="vector" className="h-full text-center">
                        <div id="headline" className="h-auto w-full px-8 py-4">
                            ...
                            <div id="text" className="grid grid-rows-2 gap-2 w-full h-full text-center text-white">
                                <div className="h-full px-4 py-2 text-7xl text-center font-headline">
                                    Spirit Membangun Indonesia Maju !
                                </div>
                                <div className="h-full px-4 py-2 text-center text-white font-sub-headline">
