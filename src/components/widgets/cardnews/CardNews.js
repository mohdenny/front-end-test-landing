...
const CardNews = () => {
    return(
        <div id="card-news" className="grid grid-cols-12 border-8 border-solid border-gray-800 mb-8">
            <div id="news-body" className="col-start-3 col-end-5 border-8 border-solid border-gray-800">
                <p className="font-bold">Berita <span className="text-red-700">Terkini</span></p>
            </div>
            <div id="news-body" className="col-start-8 col-end-11 grid grid-cols-2 ">
                <p className="ml-10text-gray-500 text-sm font-semibold">Lihat Berita Lainnya</p>
                <div className="bg-arrow-right bg-no-repeat my-auto bg-contain h-arrow-right w-4 border"></div>
            </div>
