...
const Video = () => {
    return (
        <div id="video-body" className={`${styled.videoBody.xxl} ${styled.videoBody.xl} ${styled.videoBody.lg} ${styled.videoBody.md} ${styled.videoBody.sm} ${styled.videoBody.mobile}`}>
