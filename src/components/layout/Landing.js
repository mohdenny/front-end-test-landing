...
const Landing = () => {
    return (
        <Fragment>
            ...
            <div className="container mx-auto ">
                <div id="video" className="grid 2xl:grid-cols-6 xl:grid-cols-6 lg:grid-cols-6 md:grid-cols-6 sm:grid-cols-4 h-auto w-full transform 2xl:-translate-y-72 xl:-translate-y-60 lg:-translate-y-48 md:-translate-y-36 sm:-translate-y-24 border-8 border-gray-800">
